...
import { texTokenAddress } from "./Contracts & hash/contract";
      ...
      >
        <Stack direction="row" spacing={6} justifyContent="space-between" px={8} pt={3}>
          ...
          <VStack >
            ...
            <p>The TexTokenAddress : <a href="https://rinkeby.etherscan.io/address/0x64f389CD4bB2ce03EB1F192548F8E91903406f18" style={{ color: "red" }}>{texTokenAddress}</a></p>
          </VStack>
